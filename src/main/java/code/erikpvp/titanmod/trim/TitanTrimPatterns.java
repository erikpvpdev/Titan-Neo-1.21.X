...
public class TitanTrimPatterns {
    public static final ResourceKey<TrimPattern> LEGEND = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(TitanMod.MOD_ID, "legend"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, TitanItems.LEGEND_UPGRADE_TEMPLATE, LEGEND);
    }
